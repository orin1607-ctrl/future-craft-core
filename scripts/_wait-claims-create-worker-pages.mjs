/**
 * Wait until Public Staging has the create-user claims worker type.
 */
const PUBLIC = 'https://orin1607-ctrl.github.io/future-craft-core';
const needles = ['create-user-type-claims_worker', 'עובד ניהול תביעות', 'עובד מטפל', 'claimsWorkerOnly'];
