/** Bundled additive Staging SQL. Do not edit by hand — copy from supabase/migrations. */

export const CONTROL_CENTER_SQL = `-- Additive expansion of the driver-app control center (staging/dev only).
...
export const MIGRATION_SQL = `-- Additive driver-area settings (Staging/dev). Does not drop tables, columns,
