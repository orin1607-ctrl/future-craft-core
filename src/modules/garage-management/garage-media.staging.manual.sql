...
--
-- Isolated garage media for Oren Car PUBLIC STAGING.
-- Does not touch claims_records, claims-docs, documents bucket, or /garage.
-- No DELETE of garage_customers / garage_vehicles / garage_cases.
-- ============================================================================
