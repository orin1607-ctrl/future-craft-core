...
import {
  ...
  Share2, ShieldAlert, CalendarRange, Check, ChevronsUpDown, X,
} from 'lucide-react';
 ...
 * Used for vehicle plate + internal number — scales better than long <select> lists.
 */
            ...
            <CommandGroup>
              ...
              {options.map((opt) => (
                ...
                >
                  ...
                  <span className="flex-1 text-right font-medium" dir="ltr">{opt}</span>
                </CommandItem>
              ))}
            </CommandGroup>
          </CommandList>
