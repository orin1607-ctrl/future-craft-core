...
export default function AiMarketingPage() {
  ...
  const src = `${base}ai-marketing-platform.html?fullscreen=1&v=v3-unified-3b${customerId ? `&customer=${encodeURIComponent(customerId)}` : ''}${tab ? `&tab=${encodeURIComponent(tab)}` : ''}`;
