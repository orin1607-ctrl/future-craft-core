...
import { Shield, Users, Settings, ScrollText, Building2, Mail, SlidersHorizontal, Megaphone, LayoutGrid, Smartphone } from 'lucide-react';
import HomeWorldCard from '@/components/home/HomeWorldCard';
import RoleViewLauncher from '@/components/admin/RoleViewLauncher';

const ADMIN_LINKS = [
  { to: '/driver-area-settings', icon: Smartphone, title: 'הגדרות אזור נהג', subtitle: 'כפתורים · התראות · חירום · קילומטראז׳' },
