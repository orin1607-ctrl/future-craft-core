...
export const CLAIM_DOC_TYPES: ClaimDocType[] = [
  ...
  { key: 'accident_notice', label: 'טופס אירוע / פתיחת תביעה', group: false, formLater: false, staffType: 'accident_notice', docKind: null, aliases: ['טופס הודעה על תאונה', 'טופס פתיחת תביעה חתום', 'טופס אירוע'] },
