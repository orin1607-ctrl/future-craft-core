      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            ...
            'צפה בהיסטוריית שירותים ותחזוקה',
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            ...
            'נהל כפתורי אפליקציית נהג והתראות מ"ניהול אפליקציית נהג והתראות"',
        ...
        {
          icon: <Bell className="h-5 w-5 text-primary" />,
          title: 'ניהול אפליקציית נהג והתראות',
          link: '/driver-app-notifications',
          content: [
            'בחר חברה כדי להגדיר כפתורי נהג והתראות שלה בלבד',
            'הפעל או כבה את שירות טיפול דליה לכל חברה',
            'הגדר Email ו-WhatsApp קבועים של דליה באזור הגלובלי',
            'ההגדרות נשמרות כעת בלבד — בלי שליחת הודעות אמיתית',
          ],
        },
        {
      ...
      sections: [
        {
          ...
          title: 'שירותים ותחזוקה',
          link: '/service-orders',
          content: [
            'צור קריאת שירות ותחזוקה חדשה מ"הוראות שירות"',
