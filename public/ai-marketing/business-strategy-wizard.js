...
function exportData(){
  ...
  showToast('🚀 הועבר לעוזרים, מטרות ופעולות — הורידו ואשרו דוח לפני בניית אתר');
}
