...
(function () {
  ...
  var STAGE_ADVICE = {
    ...
    strategy: {
      ...
      now: 'השלם שער חומרים — רשימת בדיקה חובה.',
      risk: 'בנייה ללא חומרים = תוכן חסר.',
      gain: 'בסיס מלא לפני מחקר SEO.',
      priority: ['חומרים', 'SEO', 'דוח'],
    },
    materials: {
      done: 'רשימת חומרים אושרה — אתר נסרק, מתחרים, מילות מפתח, שירותים, מטרות, קהל.',
      why: 'מניעת בניית אתר ללא מידע מספיק.',
      now: 'המשך לאסטרטגיית SEO.',
      risk: 'דילוג על חומרים = "חסר מידע" בתוכן.',
      gain: 'שליטה מלאה במקורות מידע.',
      priority: ['SEO', 'מתחרים', 'מילות מפתח'],
    },
    seo: {
      done: 'אסטרטגיית SEO מלאה: מתחרים, מילות מפתח, מפת דרכים, מיפוי עמודים.',
      why: 'בסיס SEO לפני בניית אתר.',
      now: 'הורד ואשר דוח Pre-Build (כולל SEO).',
      risk: 'אתר ללא אסטרטגיית SEO.',
      gain: 'דירוגים ותנועה אורגנית.',
      priority: ['דוח', 'Blueprint', 'Build'],
    },
    report: {
      done: 'דוח מקצועי מלא הופק עם 20+ סעיפים + נתוני SEO.',
