  ...
  var CAPABILITIES = [
    {
      ...
      decides: 'זהות וסטטוס אישור נפרדים. זהות חסרה ≠ חשוד. מאושר רק עם שיוך ממופה או QA מוכח.',
      returns: 'שני תגים לכל אירוע + Dropdowns + כפתורי סינון מהיר הכול/מאושרים/דורשים בדיקה/לא מזוהים/נכשלו',
      howTo: ['התחבר כ-super_admin ב-Oren Car Staging', 'מרכז ניהול → מרכז בקרה ואבטחה', 'סנן לפי זהות או סטטוס אישור בנפרד', 'לחץ על אירוע לפרטים'],
      status: 'live',
    },
    {
      id: 'evidence-v2',
