  ...
  var CAPABILITIES = [
    {
      ...
      decides: 'סיווג תצוגה בלבד: מאושר/מוכר, לא מזוהה, דורש בדיקה, נחסם/נכשל. אין ניחוש זהות ואין תווית תוקף בלי הוכחה.',
      returns: 'סינונים גלויים + חיפוש + נקה סינונים + כרטיסי מובייל עם צבע+טקסט + טבלת דסקטופ + פירוט בלחיצה',
      howTo: ['התחבר כ-super_admin ב-Oren Car Staging', 'מרכז ניהול → מרכז בקרה ואבטחה', 'סנן לפי מערכת/כלי/סיווג או לחץ על כרטיס שכבה', 'לחץ על אירוע לפרטים'],
      status: 'live',
    },
    {
      id: 'evidence-v2',
